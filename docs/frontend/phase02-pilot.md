...
[صفحۀ دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html)
...
[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#header)

##### nav

شامل لینک‌هایی به قسمت‌های مختلف صفحۀ اصلی یا سایت می‌باشد.

[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#nav)

##### main

شامل محتوای اصلی سایت می‌باشد و در اکثر مواقع بیشترین حجم از صفحه را اشغال می‌کند.

[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#main)
...
[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#aside)
...
[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#footer)
...
[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#article)
...
[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#results)

##### details

شامل بخشی از محتواست که کاربر می‌تواند در صورت نیاز آن را نمایان یا پنهان کند.

[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#details)

##### summary

همیشه داخل المان `details` استفاده می‌شود و باید شامل توضیحاتی دربارۀ آن باشد.

[مشاهده در صفحه دمو](https://mohaymen-academy.github.io/frontend-demos/pages/semantic-tags/index.html#summary)
