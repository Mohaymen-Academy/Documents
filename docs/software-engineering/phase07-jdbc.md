...
در فاز گذشته با پایگاه‌ داده و انواع دستورات آن آشنا شدیم. همچنین به عنوان تمرین، مجموعه‌ای از دستورات را به زبان sql نوشتیم. در این فاز اما می خواهیم به زبان جاوا برگردیم و ببینیم چگونه می‌توان از درون یک برنامه‌ جاوایی به پایگاه داده متصل شد و دستوراتی را روی آن اجرا کرد.
